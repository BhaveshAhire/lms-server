...
userRouter.get("/refresh", auth_1.isAuthenticated, user_controller_1.updateAccessToken);
...
userRouter.get("/get-users", user_controller_1.updateAccessToken, auth_1.isAuthenticated, (0, auth_1.authorizedRoles)("admin"), user_controller_1.getAllUsers);
userRouter.put("/update-user", user_controller_1.updateAccessToken, auth_1.isAuthenticated, (0, auth_1.authorizedRoles)("admin"), user_controller_1.updateUserRole);
userRouter.delete("/delete-user/:id", user_controller_1.updateAccessToken, auth_1.isAuthenticated, (0, auth_1.authorizedRoles)("admin"), user_controller_1.deleteUser);
