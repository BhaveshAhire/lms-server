...
exports.getUserAnalytics = (0, catchAsyncErrors_1.CatchAsyncErrors)(async (req, res, next) => {
    try {
        const users = await (0, analytics_generator_1.generatorLast12MonthsData)(user_model_1.default);
        res.status(200).json({
            success: true,
            users,
        });
...
exports.getCourseAnalytics = (0, catchAsyncErrors_1.CatchAsyncErrors)(async (req, res, next) => {
    try {
        const courses = await (0, analytics_generator_1.generatorLast12MonthsData)(course_model_1.default);
        res.status(200).json({
            success: true,
            courses,
        });
...
exports.getOrderAnalytics = (0, catchAsyncErrors_1.CatchAsyncErrors)(async (req, res, next) => {
    try {
        const orders = await (0, analytics_generator_1.generatorLast12MonthsData)(orderModel_1.default);
        res.status(200).json({
            success: true,
            orders,
        });
